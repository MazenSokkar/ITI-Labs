...
insert into Employee values ('mazen', 'sokar', 102672, '2002-04-23', 'Tanta', 'M', 3000, 112233, 30);
...
insert into Employee(Fname, Lname, SSN, Bdate, Address, Sex, Dno) values ('moaz', 'sokar', 102660, '2006-07-30', 'Tanta', 'M', 30);
